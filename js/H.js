        ...
        factory(window['H'] = {
            ...
            openFrameIndexByClick: function (framesOptionsWithHeaderSelector, hideHeaderClassName, footerSelector, triggerSelectorByFooter, triggerActiveClasses, defaultIndex) {
                ...
                that.on(that.Ds(footerSelector + " " + triggerSelectorByFooter), "touchstart", function (event) {
                    ...
                    swiperPage(_index);
                    //alert(_index);
                    if (_index == 0) H.sendEvent("index_main_refresh", null);
                    if (_index == 1) H.sendEvent("pro_index_refresh", null);
                    if (_index == 3) H.sendEvent("reload_ucenter_index", null);
                    //if (_index == 3) H.sendEvent("seting_index_refresh", null);
                });
            ...
            promptTip: function (callback, title, msg, text, type, buttons) {
                ...
                var _msg = '<div class="H-dialog-prompt-tip H-font-size-16">' + msg + '</div><input type="text" class="H-dialog-prompt-text H-width-100-percent H-border-none padding H-padding-10 H-box-sizing-border-box H-box-shadow-inset" style="border:1px solid #f1f1f1;" placeholder="请输入..." value="' + text + '" />';
